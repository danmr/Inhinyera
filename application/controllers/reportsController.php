...
//            $data['createdDate'] = $session_data['createdDate'];
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->load->view("allmembersreport.php", $data);
          //  $this->showUsers();
...
//            $data['createdDate'] = $session_data['createdDate'];
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->load->view("allmembersreportprint.php", $data);
          //  $this->showUsers();
            //print_r($this->session->userdata());  //<-- To check what's inside of userdate()
        }
        else{
    ...
    public function civilengineeringreport(){
        ...
        if($this->session->userdata('logged_in')){
            $session_data = $this->session->userdata('logged_in');         
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->pagination->initialize($config);
                $data['pagination'] = $this->pagination->create_links();
                $data['result'] = $this->managemembersModel->getCivilEngineeringList($start_row, $per_page);  
                $data['count'] = $this->countUser();    
                $data['message'] = '';
                $data['query'] = $this->userModel->getCivilEngineeringList();
                $data['allcount'] = $this->dashboardModel->getAllCount();
                $data['civilengineeringcount'] = $this->dashboardModel->getCivilEngineering();
                

                $this->load->view("civilengineeringmembersreport.php", $data);
     ...
     public function computerengineeringreport(){
        ...
        if($this->session->userdata('logged_in')){
            $session_data = $this->session->userdata('logged_in');         
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->pagination->initialize($config);
                $data['pagination'] = $this->pagination->create_links();
                $data['result'] = $this->managemembersModel->getComputerEngineeringList($start_row, $per_page);  
                $data['count'] = $this->countUser();    
                $data['message'] = '';
                $data['query'] = $this->userModel->getComputerEngineeringList();
                $data['allcount'] = $this->dashboardModel->getAllCount();
                $data['computerengineeringcount'] = $this->dashboardModel->getComputerEngineering();
                

                $this->load->view("computerengineeringmembersreport.php", $data);
         ...
         public function electricalengineeringreport(){
        ...
        if($this->session->userdata('logged_in')){
            $session_data = $this->session->userdata('logged_in');         
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->pagination->initialize($config);
                $data['pagination'] = $this->pagination->create_links();
                $data['result'] = $this->managemembersModel->getElectricalEngineeringList($start_row, $per_page);  
                $data['count'] = $this->countUser();    
                $data['message'] = '';
                $data['query'] = $this->userModel->getElectricalEngineeringList();
                $data['allcount'] = $this->dashboardModel->getAllCount();
                $data['electricalengineeringcount'] = $this->dashboardModel->getElectricalEngineering();
                

                $this->load->view("electricalengineeringmembersreport.php", $data);
         ...
         public function electronicsengineeringreport(){
        ...
        if($this->session->userdata('logged_in')){
            $session_data = $this->session->userdata('logged_in');         
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->pagination->initialize($config);
                $data['pagination'] = $this->pagination->create_links();
                $data['result'] = $this->managemembersModel->getElectronicsEngineeringList($start_row, $per_page);  
                $data['count'] = $this->countUser();    
                $data['message'] = '';
                $data['query'] = $this->userModel->getElectronicsEngineeringList();
                $data['allcount'] = $this->dashboardModel->getAllCount();
                $data['electronicsengineeringcount'] = $this->dashboardModel->getElectronicsEngineering();
                

                $this->load->view("electronicsengineeringmembersreport.php", $data);
         ...
         public function environmentalengineeringreport(){
        ...
        if($this->session->userdata('logged_in')){
            $session_data = $this->session->userdata('logged_in');         
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->pagination->initialize($config);
                $data['pagination'] = $this->pagination->create_links();
                $data['result'] = $this->managemembersModel->getEnvironmentalEngineeringList($start_row, $per_page);  
                $data['count'] = $this->countUser();    
                $data['message'] = '';
                $data['query'] = $this->userModel->getEnvironmentalEngineeringList();
                $data['allcount'] = $this->dashboardModel->getAllCount();
                $data['environmentalengineeringcount'] = $this->dashboardModel->getEnvironmentalEngineering();
                

                $this->load->view("environmentalengineeringmembersreport.php", $data);
         ...
         public function industrialengineeringreport(){
        ...
        if($this->session->userdata('logged_in')){
            $session_data = $this->session->userdata('logged_in');         
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->pagination->initialize($config);
                $data['pagination'] = $this->pagination->create_links();
                $data['result'] = $this->managemembersModel->getIndustrialEngineeringList($start_row, $per_page);  
                $data['count'] = $this->countUser();    
                $data['message'] = '';
                $data['query'] = $this->userModel->getIndustrialEngineeringList();
                $data['allcount'] = $this->dashboardModel->getAllCount();
                $data['industrialengineeringcount'] = $this->dashboardModel->getindustrialEngineering();
                

                $this->load->view("industrialengineeringmembersreport.php", $data);
         ...
         public function marineengineeringreport(){
        ...
        if($this->session->userdata('logged_in')){
            $session_data = $this->session->userdata('logged_in');         
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->pagination->initialize($config);
                $data['pagination'] = $this->pagination->create_links();
                $data['result'] = $this->managemembersModel->getMarineEngineeringList($start_row, $per_page);  
                $data['count'] = $this->countUser();    
                $data['message'] = '';
                $data['query'] = $this->userModel->getMarineEngineeringList();
                $data['allcount'] = $this->dashboardModel->getAllCount();
                $data['marineengineeringcount'] = $this->dashboardModel->getMarineEngineering();
                

                $this->load->view("marineengineeringmembersreport.php", $data);
         ...
         public function mechanicalengineeringreport(){
        ...
        if($this->session->userdata('logged_in')){
            $session_data = $this->session->userdata('logged_in');         
              ...
              //  $config['base_url'] = base_url().'/index.php/managememberController/index/showUsers';
                ...
                $this->pagination->initialize($config);
                $data['pagination'] = $this->pagination->create_links();
                $data['result'] = $this->managemembersModel->getMechanicalEngineeringList($start_row, $per_page);  
                $data['count'] = $this->countUser();    
                $data['message'] = '';
                $data['query'] = $this->userModel->getMechanicalEngineeringList();
                $data['allcount'] = $this->dashboardModel->getAllCount();
                $data['mechanicalengineeringcount'] = $this->dashboardModel->getMechanicalEngineering();
                

                $this->load->view("mechanicalengineeringmembersreport.php", $data);
...
//        $data['query'] = $this->userModel->getUsers();
        ...
        $data['message'] = '';
        $data['query'] = $this->userModel->getUsers();
        $this->load->view("allmemberreport.php", $data);
    }
