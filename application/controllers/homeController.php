    ...
    class homeController extends CI_Controller{
        ...
        public function officer(){
            ...
            if($this->session->userdata('logged_in')){
                ...
                $data['users'] = $this->managemembersModel->getUserLimited();  
            ...
            $this->load->view('officerdashboard.php', $data);
...
//if(($user_pass != "") OR ($user_confirmPass != "")){
        ...
        //else if(isset()){
           // redirect('manageUserController/index');
       // }
        $this->load->view('memberprofile.php', $data , $data2 , $data3 , $data4 , $data5 , $data6 , $data7);
