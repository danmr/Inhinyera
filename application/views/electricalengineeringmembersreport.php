...
<head>
  ...
  <title>Inhinyera | Electrical Engineering Members</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo site_url().'/homeNavBarController/electricalengineeringmembersreport'?>"><i class="fa fa-circle-o text-red"></i> <span>Electrical Engineering</span></a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i></i>Inhinyera 
            <small class="pull-right"> Total Number of EE Members: <?php echo $electricalengineeringcount ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
