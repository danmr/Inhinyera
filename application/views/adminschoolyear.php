...
<head>
  ...
  <title>Inhinyera | School Year Settings</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo site_url().'/homeNavBarController/adminschoolyear'?>">School Year</a></li>
      </ol>
    </section>
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">School Year List <br><small><a href="">CLICK HERE TO ADD</a></small></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 <?php foreach ($schoolyearlist as $index => $row){ ?>
            <tr>
            <td style="text-align: center;"><?php echo $row->schoolyear ?></td>
            <td style="text-align: center;"><?php echo $row->current ?></td>
            <td style="text-align: center;">
                <a class="editbutton" href="<?php echo site_url().'/managememberController/editUser/'.$row->schoolyearID?>"> Set Current </a>    &nbsp; &nbsp;<a> | </a>&nbsp; &nbsp;

                <a class="deletebutton" href="<?php echo base_url('index.php/schoolyearController/delete/'.$row->schoolyearID)?>" onclick="return confirm('Are you sure you want to delete <?php echo $row->schoolyear?>?')"> Delete </a>  &nbsp; 
