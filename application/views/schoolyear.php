...
<head>
  ...
  <title>Inhinyera | School Year</title>
    ...
    <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 <?php foreach ($schoolyear as $index => $row){ ?>
            <tr>
            <td style="text-align: center;"><?php echo $row->schoolyear ?></td>
            <td style="text-align: center;"><?php echo $row->current ?></td>
            <td style="text-align: center;">
                <a class="deletebutton" href="<?php echo base_url('index.php/managememberController/delete/'.$row->schoolyearID)?>" onclick="return confirm('Are you sure you want to delete <?php echo $row->schoolyear?>?')"> Delete </a>  &nbsp; &nbsp; &nbsp; &nbsp; 
                <a class="editbutton" href="<?php echo site_url().'/managememberController/editUser/'.$row->schoolyearID?>"> Set Current </a>
