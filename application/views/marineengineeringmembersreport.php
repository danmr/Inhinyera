...
<head>
  ...
  <title>Inhinyera | Marine Engineering Members</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo site_url().'/homeNavBarController/marineengineeringmembersreport'?>"><i class="fa fa-circle-o text-aqua"></i> <span>Marine Engineering</span></a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i></i>Inhinyera 
            <small class="pull-right"> Total Number of MarE Members: <?php echo $marineengineeringcount ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
