...
<head>
  ...
  <title>Inhinyera | Manage Members</title>
  ...
  <section class="content">
    ...
    <div class="box">
            ...
            <td style="text-align: center;">
                <a class="viewbutton" href="<?php echo site_url().'/managememberController/editUser/'.$row->studentID?>"> View </a> &nbsp;  <a> | </a> &nbsp; 
                <a class="editbutton" href="<?php echo site_url().'/managememberController/editUser/'.$row->studentID?>"> Edit </a> &nbsp;  <a> | </a> &nbsp; 
