...
<head>
  ...
  <title>Inhinyera | Environmental Engineering Members</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo site_url().'/homeNavBarController/civilengineeringmembersreport'?>"><i class="fa fa-circle-o text-orange"></i> <span>Civil Engineering</span></a></li>
        ...
        <li class="active"><a href="<?php echo site_url().'/homeNavBarController/environmentalengineeringmembersreport'?>"><i class="fa fa-circle-o text-green"></i> <span>Environmental Engineering</span></a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i></i>Inhinyera 
            <small class="pull-right"> Total Number of ENSE Members: <?php echo $environmentalengineeringcount ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
