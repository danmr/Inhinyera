...
<head>
  ...
  <title>Inhinyera | Administrator Log in</title>
  ...
  <div class="login-box-body" id="login">
   ...
   <?php if($this->session->flashdata('failed')){?>
    ...
    <div class="social-auth-links text-center">
      ...
      <a href="<?php echo site_url().'/loginController/index'?>" class="btn btn-block btn-social btn-vk btn-flat"><i class="fa fa-dashboard"></i>LOG IN AS STUDENT</a>
    </div>
