...
<head>
  ...
  <title>Inhinyera | Computer Engineering Members</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo site_url().'/homeNavBarController/computerengineeringmembersreport'?>"><i class="fa fa-circle-o text-green"></i> <span>Computer Engineering</span></a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i></i>Inhinyera 
            <small class="pull-right"> Total Number of CpE Members: <?php echo $computerengineeringcount ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
