...
<html>
  <head>
    ...
    <title>Inhinyera | Edit Member College Details</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <h1>
             <?php echo $studentID ?>
            <small>Edit college  Education Details </small>
          </h1>
        </div>
        ...
        <section id="personalinfo">
           <div class="row">
              ...
              <div class="box box-default">
               <div class="box-header with-border">
                  <i class="fa fa-graduation-cap"></i>
                   ...
                   <h3 class="box-title">College Education</h3>
              </div>
            <!-- /.box-header -->
            <div class="box-body">
            <div class="col-xs-8">
            ...
            <input class="form-control" id="college" name="college" type="text" rows="2" placeholder="College Attended" >
            </div>
            <br>
            <br>
            <br>
            <br>
            <br>
            <div class="col-xs-6" id='TextBoxesGroupcollege'>
            <div id="TextBoxcollegeAwards">
            <label for=achievementcollege>Awards/Honors Received</label>
            <input class="form-control" id="achievementcollege" name="achievementcollege" type="text" placeholder="1. College  Achievement" rows="2" value="<?php echo $achievementcollege ?>">
            <input class="form-control" id="achievementcollege2" name="achievementcollege2" type="text" placeholder="2. College  Achievement" rows="2" value="<?php echo $achievementcollege2 ?>" >
            <input class="form-control" id="achievementcollege3" name="achievementcollege3" type="text" placeholder="3. College  Achievement" rows="2" value="<?php echo $achievementcollege3 ?>">
            <input class="form-control" id="achievementcollege4" name="achievementcollege4" type="text" placeholder="4. College  Achievement" rows="2" value="<?php echo $achievementcollege4 ?>" >
            </div>
            <input class="form-control" id="achievementcollege5" name="achievementcollege5" type="text" placeholder="5. College  Achievement" rows="2" value="<?php echo $achievementcollege5 ?>">
            <input class="form-control" id="achievementcollege6" name="achievementcollege6" type="text" placeholder="6. College  Achievement" rows="2" value="<?php echo $achievementcollege6 ?>">
            <input class="form-control" id="achievementcollege7" name="achievementcollege7" type="text" placeholder="7. College  Achievement" rows="2" value="<?php echo $achievementcollege7 ?>">
            <input class="form-control" id="achievementcollege8" name="achievementcollege8" type="text" placeholder="8. College  Achievement" rows="2" value="<?php echo $achievementcollege8 ?>" >
            <input class="form-control" id="achievementcollege9" name="achievementcollege9" type="text" placeholder="9. College  Achievement" rows="2" value="<?php echo $achievementcollege9 ?>">
            <input class="form-control" id="achievementcollege10" name="achievementcollege10" type="text" placeholder="10. College  Achievement" rows="2" value="<?php echo $achievementcollege10 ?>">
            <br>
            </div>
