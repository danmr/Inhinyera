      ...
      <div class="content-wrapper">
        ...
        <section id="personalinfo">
           <div class="row">
            ...
            <input class="form-control" id="elementary" name="elementary" type="text" rows="2" placeholder="Elementary School" >
            </div>
            <br>
            <br>
            <br>
            ...
            <input class="form-control" id="achievementelementary" name="achievementelementary" type="text" placeholder="1. Elementary Achievement" rows="2" >
            <input class="form-control" id="achievementelementary" name="achievementelementary" type="text" placeholder="2. Elementary Achievement" rows="2" >
            <input class="form-control" id="achievementelementary" name="achievementelementary" type="text" placeholder="3. Elementary Achievement" rows="2" >
            <input class="form-control" id="achievementelementary" name="achievementelementary" type="text" placeholder="4. Elementary Achievement" rows="2" >
            </div>
            <input class="form-control" id="achievementelementary" name="achievementelementary" type="text" placeholder="5. Elementary Achievement" rows="2" >
            <input class="form-control" id="achievementelementary" name="achievementelementary" type="text" placeholder="6. Elementary Achievement" rows="2" >
            <br>
            </div>
