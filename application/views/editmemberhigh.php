      ...
      <div class="content-wrapper">
        ...
        <section id="personalinfo">
           <div class="row">
            ...
            <input class="form-control" id="achievementhigh" name="achievementhigh" type="text" placeholder="1. High School Achievement" rows="2" >
            <input class="form-control" id="achievementhigh2" name="achievementhigh2" type="text" placeholder="2. High School Achievement" rows="2" >
            <input class="form-control" id="achievementhigh3" name="achievementhigh3" type="text" placeholder="3. High School Achievement" rows="2" >
            <input class="form-control" id="achievementhigh4" name="achievementhigh4" type="text" placeholder="4. High School Achievement" rows="2" >
            </div>
            <input class="form-control" id="achievementhigh5" name="achievementhigh5" type="text" placeholder="5. High School Achievement" rows="2" >
            <input class="form-control" id="achievementhigh6" name="achievementhigh6" type="text" placeholder="6. high School Achievement" rows="2" >
            <br>
            </div>
