      ...
      <div class="content-wrapper">
        ...
        <section id="personalinfo">
           <div class="row">
            ...
            <input class="form-control" id="achievementcollege" name="achievementcollege" type="text" placeholder="1. College  Achievement" rows="2" >
            <input class="form-control" id="achievementcollege2" name="achievementcollege2" type="text" placeholder="2. College  Achievement" rows="2" >
            <input class="form-control" id="achievementcollege3" name="achievementcollege3" type="text" placeholder="3. College  Achievement" rows="2" >
            <input class="form-control" id="achievementcollege4" name="achievementcollege4" type="text" placeholder="4. College  Achievement" rows="2" >
            </div>
            <input class="form-control" id="achievementcollege5" name="achievementcollege5" type="text" placeholder="5. College  Achievement" rows="2" >
            <input class="form-control" id="achievementcollege6" name="achievementcollege6" type="text" placeholder="6. College  Achievement" rows="2" >
            <br>
            </div>
