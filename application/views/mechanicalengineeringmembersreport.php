...
<head>
  ...
  <title>Inhinyera | Mechanical Engineering Members</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo site_url().'/homeNavBarController/mechanicalengineeringmembersreport'?>"><i class="fa fa-circle-o text-brown"></i> <span>Mechanical Engineering</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i></i>Inhinyera 
            <small class="pull-right"> Total Number of ME Members: <?php echo $mechanicalengineeringcount ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
