...
<html>
  <head>
    ...
    <title>Inhinyera | Edit Member Case</title>
      ...
      <aside class="main-sidebar">
        ...
        <div class="sidebar" id="scrollspy">
          ...
          <ul class="nav sidebar-menu">
            ...
            <li class="active"><a href="<?php echo site_url().'/managememberController/admineditUsercase/'.$row->studentID?>"><i class="fa fa-balance-scale"></i> Disciplinary Case</a></li>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <h1>
            ...
            <small>Edit Member Disciplinary Case</small>
          </h1>
        </div>
           ...
           <div class="row">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <textarea id="caseexplain" name="caseexplain" class="form-control" rows="3" placeholder="<?php echo $caseexplain ?>" value="<?php echo $caseexplain ?>"></textarea>
                </div>
            <!-- /.box-body -->
            </div>
          <!-- /.box -->
